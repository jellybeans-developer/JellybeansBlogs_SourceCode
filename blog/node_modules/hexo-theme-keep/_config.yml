...
social_contact:
  ...
  links:
    ...
    github: https://github.com/jellybeans-developer # 只有在first_screen.enable设置为true时，social_contact.enable设置为true才会显示在页面上
    weixin:          # WeChat
    qq:              # QQ
    weibo:           # WeiBo
    zhihu:           # ZhiHu
...
post:
  ...
  reward:
    enable: true        # Option values: true | false
    img_link:  /imgaes/Logo.png          # Image link for the payment QR code
    text:    打赏作者            # Custom reward text, Can be null
...
# ---------------------------------------------------------------------------------------
footer:
  since: 2026            # The starting year of your website, Can be null
  ...
  record:
    enable: true        # Option values: true | false
    list:
      - code: 沪ICP备2026015575号-1         # record code of your website
